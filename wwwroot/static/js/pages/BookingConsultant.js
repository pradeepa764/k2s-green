...
const BookingConsultant = () => {
    ...
    return ( <
        ...
        <
        p >
        Transitioning to renewable energy, sustainable practices, and carbon credit monetization can be complex.At K2S Green, we simplify the process with expert, data - driven consultation services tailored
        for businesses,
        energy distributors, and individuals.Whether you’ re installing wind, solar, or hydrogen solutions, need guidance on ESG compliance, or want to monetize carbon credits, our experts are here to chart your path to a cleaner, cost - effective future. <
        /p> <
        Link to = "/contact"
        ...
        p className = "pdt20" > Our services are designed
        for anyone ready to take control of their energy future : < /p> <
        /div> <
        /Col> <
        /Row> <
