...
const privacyPolicy = () => {
        return ( <
            ...
            p > The words of which the initial letter is capitalized have meanings defined under the following conditions.The following definitions shall have the same meaning regardless of whether they appear in
        ...
        refers to K2S Consulting Pvt Ltd, Plot 5 & amp;
        6, Allied House, Vasant Kunj, New
        Delhi 110070. < /p> <
            /li> <
            li >
            <
        ...
        Service or from the Service infrastructure itself(
            ...
            li >
            <
            p > < strong > Website < /strong> refers to K2S Consulting, accessible from <a href="https:/ / www.k2s.co " rel="
        external nofollow noopener " target="
        _blank ">https://www.k2s.co</a></p> <
            /li> <
            li >
            <
...
objects(or Flash Cookies) to collect and store information about Your preferences or Your activity on
our Service.Flash
...
local shared objects ? " available at <a href="
...
purchase contract
for the products, items or services You have purchased or of
...
with Us. < /li> <
li > < strong > With business partners:
    < /strong> We may share Your information with Our
    ...
    Your consent. < /li> <
        ...
        p > The Company will retain Your Personal Data only
    ...
    disputes, and enforce our legal agreements and policies. < /p> <
        p > The Company will also retain Usage Data
    ...
    information from Our servers. < /p> <
        p > If We need to rely on consent as a legal basis
    ...
    the Privacy Policy of
        ...
        p > We have no control over and assume no responsibility
    ...
    effective when they are posted on this page. < /p> <
        ...
        li >
        <
        p > By visiting this page on our website: < a href = "https://www.k2s.co/contact"
    rel = "external nofollow noopener"
    target = "_blank" > https: //www.k2s.co/contact</a></p>
        <
        /li> <
        li >
        <
